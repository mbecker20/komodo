      ...
      "": [
        {
          ...
          components: {
            resource_path: {
              ...
              description:
                "Provide the path to resources. Supports a '.toml' file, or folder of '.toml' files.",
            },
            delete: !managed && {
        ...
        },
        {
          ...
          components: {
            resource_path: {
              placeholder: "./resources",
              description:
                "Provide the path to resources, relative to the root of the repo. Supports a '.toml' file, or folder of '.toml' files.",
            },
            delete: !managed && {
              label: "Delete Unmatched Resources",
              description:
...
export const ResourceSyncConfig2 = ({
  id,
  titleOther,
}: {
  id: string;
