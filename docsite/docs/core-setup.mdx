...
<RemoteCodeFile
	url="https://raw.githubusercontent.com/mbecker20/komodo/main/config_example/core.compose.yaml"
	title="https://github.com/mbecker20/komodo/blob/main/config_example/core.compose.yaml"
	language="yaml"
/>
```
